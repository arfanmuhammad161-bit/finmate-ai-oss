    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-text-main tracking-tight">Target Keuangan</h2>
            <p className="text-sm text-text-muted mt-0.5">Wujudkan impian dengan perencanaan cerdas</p>
          </div>
        </div>
